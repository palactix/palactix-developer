...
import { fetchBlogBySlug, fetchBlogCategoriesWithPosts } from "@/features/blog/blog.api";
import type { BlogPost, BlogCategoryPosts } from "@/features/blog/blog.type";
...
export default async function BlogDetailPage({ params, searchParams }: BlogDetailPageProps) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-linear-to-b from-background to-muted/30 py-12 pt-20">
        <Container>
